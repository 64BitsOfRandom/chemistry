...
//                        .id(resultSet.getInt(ID_COL_NAME))
...
//            }
//        } catch (SQLException ex) {
//            log.error("Failed to get Formula by id #{}!");
//        }
//        if(formula != null) log.info("Retrieved formula #{} is fine");
//        else log.warn("Something wrong with #{}. Check is such formula even exists");
//        return formula;
//    }
//
////    @Override
////    public Formula getSubstances() {
////        Formula formula = null;
////        try (Connection connection = null;
////             PreparedStatement statement = connection.prepareStatement(selectAllQuery)) {
////            statement.setString(1, SUBSTANCES_TABLE_NAME); //TODO: find more convenient way
////            ResultSet resultSet = statement.executeQuery();
////            if (resultSet.next()) {
////                formula = Formula.builder()
////                        .id(resultSet.getInt(ID_COL_NAME))
...
//
////    @Override
//    public Formula getClasses() {
//        Formula formula = null;
//        try (Connection connection = null;
//             PreparedStatement statement = connection.prepareStatement(selectAllQuery)) {
//            statement.setString(1, CLASSES_TABLE_NAME); //TODO: find more convenient way
//            ResultSet resultSet = statement.executeQuery();
//            if (resultSet.next()) {
//                formula = Formula.builder()
//                        .id(resultSet.getInt(ID_COL_NAME))
...
//
////    @Override
//    public Ion getClassById(int ionId) {
//        Ion ion = null;
//        try (Connection connection = null;
//             PreparedStatement statement = connection.prepareStatement(selectQuery)) {
//            statement.setString(1, CLASSES_TABLE_NAME);
//            ResultSet resultSet = statement.executeQuery();
//            if (resultSet.next()) {
//                ion = Ion.builder()
//                        .id(ionId)
